...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            WebDriverWait wait = new WebDriverWait(driver,30);
            wait.until(ExpectedConditions.or(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//p[contains(text(),'YONEX')]"), product),
    ...
    public Boolean addProductToCart(String productName) {
        try {
            ...
            for (WebElement cell : gridContent) {
                if (productName.contains(cell.findElement(By.xpath("//p[contains(@class,'css-yg30e6')]")).getText())) {
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            WebElement cartParent = driver.findElement(By.xpath("//div[@class='MuiBox-root css-1gjj37g']"));
            List<WebElement> cartContents = cartParent.findElements(By.xpath("./child::div[1]"));

            ArrayList<String> actualCartContents = new ArrayList<String>() {
            };
            for (WebElement cartItem : cartContents) {
                actualCartContents.add(cartItem.findElement(By.xpath("//div[@class='MuiBox-root css-1gjj37g']/child::div[1]")).getText().split("\n")[0]);
            }
